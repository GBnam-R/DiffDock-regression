...
def get_parser():
    ...
    parser.add_argument('--protein_path', type=str, default='/home/serve/Gibeom/test/test2/DiffDock/data/1a0q/1a0q_protein_processed.pdb', help='Path to the protein file')
    ...
    parser.add_argument('--ligand_description', type=str, default='/home/serve/Gibeom/test/test2/DiffDock/data/1a0q/1a0q_ligand.sdf', help='Either a SMILES string or the path to a molecule file that rdkit can read')
...
def main(args):
    ...
    rot_schedule = get_t_schedule(sigma_schedule='expbeta', inference_steps=args.inference_steps)
    tor_schedule = get_t_schedule(sigma_schedule='expbeta', inference_steps=args.inference_steps)
    ...
    for idx, orig_complex_graph in tqdm(enumerate(test_loader)):
        ...
        try:
            ...
            # # 임베딩을 파일에 저장
            # np.save(os.path.join(args.out_dir, 'final_embeddings.npy'), np.array(final_embeddings))
